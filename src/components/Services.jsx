  ...
  return (
    <div className="flex-container">
      <div className="flex-row-container">
        <section>
          <h2 className='section-header'>Front-End Development</h2>
        ...
        <section>
          <h2 className='section-header'>Frameworks & Libraries</h2>
        ...
        <section>
          <h2 className='section-header'>Database Management</h2>
        ...
        <section>
          <h2 className='section-header'>Emerging Technologies</h2>
      ...
      <footer>
        I'm committed to delivering quality web solutions that are tailored to your unique requirements. Whether it's a simple website or a complex web application, my focus is on creating an engaging user experience without overcomplicating things. Let's build something great together.
      </footer>
    </div>
  );
}
